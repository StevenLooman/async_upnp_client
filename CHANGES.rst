...
async_upnp_client 0.47.0 (2026-04-19)
=====================================
...
- Improve parsing of state variable type in non-strict mode.
  ...
  E.g. a state variable declared with type `DateTime` will be parsed as `dateTime` in non-strict mode. (#300)
...
async_upnp_client 0.46.2 (2026-01-03)
=====================================

Features
--------

- Bump python-didl-lite 1.5.0 (#290)
